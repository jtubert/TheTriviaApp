...
//curl -X POST   -H "X-Parse-Application-Id: XLA1dDUeG60GkpWscXc3qdGHaxDgplKTvSxK5Oeh"   -H "X-Parse-REST-API-Key: rfO56oIFiSvM9nBtybZdyujhygZvCfCXjAhN12y3"   -H "Content-Type: application/json"   -d '{}'   https://api.parse.com/1/functions/listsStatuses
