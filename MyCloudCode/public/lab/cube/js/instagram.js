...
com.jtubert.instagram = function(){
	...
	this.init = function(obj){		
		...
		if(window.location.href.indexOf("http://localhost") == 0){
			...
			$("#login").append("<a href='https://instagram.com/oauth/authorize/?client_id=16650ae8b4094996b21367c76a95845a&redirect_uri=http://jtubert.parseapp.com/lab/cube?mode=instagram&type="+obj.type+"&response_type=token'>Add instagram images</a>");
		}		
