...
com.jtubert.instagram = function(){
	...
	this.init = function(obj){		
		...
		if(window.location.href.indexOf("http://localhost") == 0){
			$("#login").append("<a href='https://instagram.com/oauth/authorize/?client_id=10b957025e7d4173b00207cbdec99360&redirect_uri=http://localhost:8888/git/cube/?mode=instagram&type="+obj.type+"&response_type=token'>Add instagram images</a>");
		}else{
			$("#login").append("<a href='https://instagram.com/oauth/authorize/?client_id=10b957025e7d4173b00207cbdec99360&redirect_uri=http://jtubert.parseapp.com/lab/three_js/?mode=instagram&type="+obj.type+"&response_type=token'>Add instagram images</a>");
		}		
