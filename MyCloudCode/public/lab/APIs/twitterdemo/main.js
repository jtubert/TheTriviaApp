        ...
        callback: function (e) {
            ...
            if (v)
                for (c = c.getElementsByClassName("tweet"); d < c.length;) {
                    //console.log("xxxxxxx ",c[d].getElementsByClassName("autosized-media")[0]);
                    
                    0 < c[d].getElementsByClassName("retweet-credit").length ? a.push(!0) : a.push(!1);
                    if (!a[d] || a[d] && z) e.push(c[d].getElementsByClassName("e-entry-title")[0]), h.push(c[d].getAttribute("data-tweet-id")), g.push(c[d].getElementsByClassName("p-author")[0]), f.push(c[d].getElementsByClassName("dt-updated")[0]), imgs.push(c[d].getElementsByClassName("autosized-media"));
                    d++
                } else
            ...
            for (a = 0; a < d;) {
              ...
              if(imgs[a].length){
                b = '<div class="image">' + getString(imgs[a]) + '</div>'
              }else{
                b = ''
              }
...
function getString(node){
  ...
  if(node.length > 0){
       ...
       div.innerHTML = node[0].nodeValue;
       str = node[0].parentNode.innerHTML;
  }
...
// hashtags.
twitterFetcher.fetch('423303017434071043', 'demo', 10, true, true, true);
